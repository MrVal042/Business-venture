...
export default class middleSection extends Component {
  constructor(props) {
    ...
    this.state = {navIsOpen: false, visibility:false, modalIsOpen: false,  checked: false, header:'' };
  }
  ...
  toggleModal = (e) => {
    ...
    let headerTxt = e.currentTarget.parentElement.firstElementChild.innerHTML;
    console.log(headerTxt)
    this.setState(state => state.header = headerTxt);
  }
    ...
    return (
      <>
        ...
        <Modal show={this.state.modalIsOpen} checked = {this.state.checked}
          ...
          header={this.state.header} onClose={this.toggleModal}>
        </Modal>
        ...
        <section id="investment">
          ...
          <div className="grid-content">
            ...
            <div className="txtContainer">
              ...
              <p> You stand a chance of making more money if you choose to refer<span>&#9997;&#127996;</span></p>
